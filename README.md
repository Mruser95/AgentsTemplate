...
Tools/   plan_io · working_todo · terminal · browser · tavily · schedule · skills · linter · write_file · mcp
...
- **checker hard gate**：`plan_io` 在 subtask 标记 done 时自动调 `checker`，输出 `on_track / minor_drift / major_drift / off_track`。
...
| [Agents/](Agents/) | manager / checker / tester / coder / tasker_coder / collator / retriver / remember |
